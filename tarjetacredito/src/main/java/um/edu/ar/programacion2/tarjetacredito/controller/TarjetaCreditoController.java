package um.edu.ar.programacion2.tarjetacredito.controller;
...
import um.edu.ar.programacion2.tarjetacredito.service.TarjetaCreditoService;
...
public class TarjetaCreditoController {
	@Autowired
    private TarjetaCredito tarjetacreditoService;
...
/*
    ...
    */
	...
	public ResponseEntity<TarjetaCredito> createTarjetaCredito(@RequestBody TarjetaCredito tarjetacredito) {
    	...
    	return ResponseEntity.ok(tarjetacreditoService.createTarjetaCredito(venta));
